...
const Logo:FC<LogoProps> = ({ theme }) => {
    ...
    return (
        <svg width="500" height="500" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg" className="logo logo-light-background">
            ...
            <circle cx="106" cy="210" r="75" fill={fillColor} />
            <ellipse cx="396" cy="205.503" rx="75" ry="79.5033" fill={fillColor} />
            <circle cx="251" cy="170" r="115" fill={fillColor} />
            <rect x="106" y="188" width="290" height="97" fill={fillColor} />
            <ellipse cx="326.375" cy="307.5" rx="144.375" ry="137.5" fill={fillColor} />
            <path
