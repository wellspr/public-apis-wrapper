const Logo = () => {
    ...
    return (
        <svg width="500" height="500" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg" className="logo logo-light-background">
            <rect x="2.5" y="-2.5" width="495" height="495" rx="47.5" transform="matrix(1 0 0 -1 1 495)"
                fill="none" stroke="none" strokeWidth="10" />
            <circle cx="106" cy="210" r="75" fill="#1E1E1E" />
            <ellipse cx="396" cy="205.503" rx="75" ry="79.5033" fill="#1E1E1E" />
            ...
            <path
                ...
                stroke="#D9D9D9" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M191.625 261.463H461.125" stroke="#D9D9D9" strokeWidth="10" strokeLinecap="round"
                strokeLinejoin="round" />
            <path d="M191.625 352.927H461.125" stroke="#D9D9D9" strokeWidth="10" strokeLinecap="round"
                strokeLinejoin="round" />
